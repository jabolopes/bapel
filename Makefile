...
all: bpl bootstrap/parser bootstrap/test_runner program query
...
tests/test_runner: tests/test_main.cc tests/test_util.h $(TEST_SRCS) bootstrap/parser
...
.PHONY: bpl
bpl: bootstrap/parser bootstrap/bpl tests/test_runner
	./tests/test_runner
...
.PHONY: bootstrap
bootstrap: bpl bootstrap/parser bootstrap/test_runner
