...
func CompileCCMToPCMCommand(inputFilename string, flags []string, outputFilename string) (*exec.Cmd, error) {
	...
	return exec.Command("clang++", args...), nil
}

// Example:
// $ clang++ -std=c++20 -fprebuilt-module-path=out -c out/game-game_impl.pcm -o out/game-game_impl.o
func CompilePCMToObjCommand(inputFilename string, outputFilename string) (*exec.Cmd, error) {
...
//	  out/arr-arr_impl.o \
//	  ...
func LinkObjsToExecutableCommand(inputFilenames, flags []string, outputFilename string) (*exec.Cmd, error) {
