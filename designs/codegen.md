...
5. **Verification & Parity Test Harness:**
   - **Target Files:** [comp/cpp_printer_test.go](comp/cpp_printer_test.go), Bapel compiler e2e tests
   - Implement an equivalence test suite comparing C++ output generated by native Bapel [bin/codegen.bpl](bin/codegen.bpl) against [comp/cpp_printer.go](comp/cpp_printer.go) to guarantee output equivalence before proceeding to Phase 7.
