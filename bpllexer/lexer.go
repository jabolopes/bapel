...
func (l *Lexer) Current() string           { return l.l.Current() }
func (l *Lexer) Emit(t lexerfsm.TokenType) { l.l.Emit(t) }
func (l *Lexer) Ignore()                   { l.l.Ignore() }
func (l *Lexer) Next() rune                { return l.l.Next() }
func (l *Lexer) Peek() rune                { return l.l.Peek() }
func (l *Lexer) PeekAll(str string) bool   { return l.l.PeekAll(str) }
func (l *Lexer) TakeAll(str string) bool   { return l.l.TakeAll(str) }
func (l *Lexer) Error(err string) {
	l.outErrors = append(l.outErrors, fmt.Sprint("Parse error: ", err))
}

// ShiftWord returns the next token and 'true' if the stream is not
// empty, otherwise it returns 'false'.
func (l *Lexer) ShiftWord() (lexerfsm.Token, bool) {
	return l.l.NextToken()
}
...
func (l *Lexer) ScanErr() error {
	if len(l.outErrors) > 0 {
		return errors.New(strings.Join(l.outErrors, "\n"))
	}
...
func New(data string) *Lexer {
	lexer := &Lexer{lexerfsm.New(data), nil /* outErrors */}
	lexer.l.Start(lexer.initialState)
	return lexer
}
